...
<hr>
<div id="exercisecontainer" src="xrcise_css.js"></div>
<hr>
...
<a href="https://youtu.be/cZHp-Oozg6I&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
  <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
    <div style="position:absolute;top:40%;text-align: center;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/11_html_css.webp" type="image/webp" />
        <img src="images/11_html_css.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
<br>
